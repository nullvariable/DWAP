local wtc1 = {x = 6663, y = 5502, z = -1,}
local RiversideMansion = {
    spawn = { x = 6674, y = 5514, z = 1 },
    generators = {
        {
            controls = { sprite = "industry_02_67", x = 6666, y = 5500, z = -1, },
            chunks = {
                {832, 687},
                {832, 688},
                {832, 689},
    ...
    waterTanks = {
        { sprite = "industry_02_75", x = wtc1.x, y = wtc1.y, z = wtc1.z, sourceType="generator", source = {x = 6666, y = 5500, z = -1} },
    },
    waterFixtures = {
        -- 2nd floor
