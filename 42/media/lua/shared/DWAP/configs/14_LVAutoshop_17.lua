...
local loot = BunkerShell(
    { x = bunkerTopLeft.x, y = bunkerTopLeft.y + 2, z = bunkerTopLeft.z },
    {
        ...
        E4  = { sprite = "location_trailer_02_23", dist = { "ButcherSpices", "GigamartSpices", "CrateCannedFood", "KitchenCannedFood" } },
        E6  = { dist = { "LaundryCleaning", "JanitorCleaning" }, tag = "DWAPFood" },
