local wtc0 = {x = 14152, y = 2632, z = -1,} -- tank for the core area
local wtc1 = {x = 14147, y = 2658, z = -1,} -- tank for the southern house
...
local LVilleComplex = {
    ...
    waterTanks = {
        { sprite = "industry_02_72", x = wtc0.x, y = wtc0.y, z = wtc0.z, sourceType="generator", source = {x = 14156, y = 2632, z = -4} },
        { sprite = "industry_02_72", x = wtc1.x, y = wtc1.y, z = wtc1.z, sourceType="generator", source = {x = 14156, y = 2632, z = -4} },
        { sprite = "industry_02_72", x = wtc2.x, y = wtc2.y, z = wtc2.z, sourceType="generator", source = {x = 14156, y = 2628, z = -4} },
        { sprite = "industry_02_72", x = wtc3.x, y = wtc3.y, z = wtc3.z, sourceType="generator", source = {x = 14156, y = 2624, z = -4} },
    },
    waterFixtures = {
        -- core -1
    ...
    loot = {
        ...
        -- {
        --     type = 'container',
        --     coords = {x=bunker2TopLeft.x,y=bunker2TopLeft.y+2,z=bunker2TopLeft.z},
        --     sandboxEnable = 'Loot_EnableMaps',
        --     special = "maps",
        -- },
        {
...
--     table.insert(LVilleComplex.objectSpawns, { sprite = "industry_trucks_01_7", x = 117, y = 8957, z = -1, removeWall = "north", })

--     table.insert(LVilleComplex.objectSpawns, { sprite = "walls_exterior_wooden_01_28", x = 117, y = 8925, z = 0, removeFloor = true, clearExisting = true, })
--     table.insert(LVilleComplex.objectSpawns, { sprite = "walls_exterior_wooden_01_29", x = 117, y = 8926, z = 0, })
-- end
