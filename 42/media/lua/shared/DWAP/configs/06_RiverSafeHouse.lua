...
local RiverSafeHouse = {
    ...
    generators = {
        {
            controls = { sprite = "dwap_tiles_01_22", x = 6953, y = 5565, z = -1 },
...
if getActivatedMods():contains("\\Ladders") then
    ...
    table.insert(RiverSafeHouse.objectSpawns,
        { enabled = "EnableLadders", x = 6957, y = 5569, z = -1, removeWall = "west" })
    table.insert(RiverSafeHouse.objectSpawns,
        { enabled = "EnableLadders", sprite = "walls_exterior_wooden_01_34", x = 6957, y = 5569, z = -1 })
    table.insert(RiverSafeHouse.objectSpawns,
        { enabled = "EnableLadders", sprite = "fixtures_doors_01_12", x = 6957, y = 5569, z = -1, isDoor = true, doorN = false, })
    table.insert(RiverSafeHouse.objectSpawns,
        { enabled = "EnableLadders", sprite = "location_shop_bargNclothes_01_24", x = 7009, y = 5591, z = 0, removeFloor = true, })
    table.insert(RiverSafeHouse.objectSpawns,
        { enabled = "EnableLadders", sprite = "location_shop_bargNclothes_01_25", x = 7009, y = 5592, z = 0, })
end
