...
local specs = {
    ...
    { id = "E2", dx = 0, dy = 1, dz = 0,
        ...
        distIncludeJunk = false, randUntilFull = true, level = "Loot_FoodLevel" },
    ...
    { id = "E5", dx = 0, dy = 2, dz = 0,
        ...
        distIncludeJunk = false, randUntilFull = true, level = "Loot_MedLevel" },
    { id = "E6", dx = 0, dy = 3, dz = 0,
        sprite = "location_trailer_02_23", note = "overhead @ bunker", slot = "upper",
        dist = { "CrateFishing", "FishermanTools" },
        distIncludeJunk = false, randUntilFull = true, level = "Loot_FishLevel" },
    { id = "E7", dx = 0, dy = 3, dz = 0,
        sprite = "location_trailer_02_19", note = "counter @ bunker",
        dist = { "SewingStoreTools" },
        distIncludeJunk = true, randUntilFull = true, level = "Loot_TailorLevel" },
    { id = "E8", dx = 0, dy = 4, dz = 0,
        note = "fridge @ bunker",
        dist = { "FridgeFarmStorage", "FridgeGeneric" },
        distIncludeJunk = true, randUntilFull = true, level = "Loot_FoodLevel" },
    ...
    { id = "E10", dx = 0, dy = 5, dz = 0,
        ...
        distIncludeJunk = false, randUntilFull = true, level = "Loot_FarmLevel" },
    ...
    { id = "E16", dx = 2, dy = 3, dz = 0,
        ...
        distIncludeJunk = false, randUntilFull = true, level = "Loot_MediaLevel" },
    { id = "E17", dx = 2, dy = 3, dz = 0,
        stack = 2, note = "militarycrate @ bunker",
        dist = { "MeleeWeapons", "MeleeWeapons_Mid", "SafehouseTraps", "CampingLockers" },
        distIncludeJunk = true, randUntilFull = true, level = "Loot_GunLevel" },
    ...
    { id = "E20", dx = 2, dy = 5, dz = 0,
        ...
        distIncludeJunk = true, randUntilFull = true, level = "Loot_FarmLevel" },
    ...
    { id = "E22", dx = 2, dy = -2, dz = 0,
        ...
        distIncludeJunk = true, randUntilFull = true, level = "Loot_ToolsLevel" },
    { id = "E23", dx = 2, dy = -2, dz = 0,
        note = "crate @ bunker", stack = 2,
        dist = { "CrateLumber", "CrateSheetMetal", "CrateMasonry", "ArtStorePottery" },
        distIncludeJunk = true, randUntilFull = true, level = "Loot_BuildMatsLevel" },
    { id = "E24", dx = 2, dy = -1, dz = 0,
        note = "crate @ bunker", stack = 1,
        dist = { "SafehouseTraps", "GunStoreKnives", "CarSupplyTools" },
        distIncludeJunk = true, randUntilFull = true, level = "Loot_LockersLevel" },
...
local scalarFields = {
    ...
    "distIncludeJunk", "randUntilFull", "level", "sprite",
}
...
return function(origin, overrides)
    ...
    for i = 1, #specs do
        ...
        -- dist-bearing entries are pinned; specials are guaranteed by fill code
        if spec.dist and not spec.special then
            entry.pin = true
        end
