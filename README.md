...
| Optional mods supported | * Ladders!? * Functional Appliances 2 |
...
| The large basement of this gas station sports a water tank and generator supplying the whole building. A comfortable upstairs apartment features all the latest amenities while the ample storage areas contain plenty of supplies. Gas pumps are also wired to the generator. | ![Rosewood Gas Station](readme/07_basement.png) |
| Optional mods supported | * Ladders!? |
...
| Optional mods supported | * [Taylorsville](https://steamcommunity.com/sharedfiles/filedetails/?id=3134394569) * Ladders!? |
...
| Optional mods supported | * Functional Appliances 2 |
...
| Optional mods supported | * Gun's Elevator mod |
...
| 31. Prison Break | 7674, 12268 |
| ------------- | ---------- |
| ![Prison Break](readme/31_main.jpg) | ![Prison Break](readme/31_map.png) |
| A high profile prison break occurred using this tunnel. Authorities claim that it's been sealed off and poses no risk to the public. You'll find that many of the amenities and tools used to build the tunnel were left behind and the shelter space is well suited to waiting out any disaster.
*Do you relish a challenge? This map offers a spawn point inside the prison with a few contraband items. Good luck making it to the escape tunnel!* | ![Prison Break](readme/31_basement.png) |
| Optional mods supported | * Ladders!? |
| ***Pros***: Fairly isolated, easy access to the prison basement, lots of materials for building the ultimate prison fortress | ***Cons***: This tunnel is super long for regular use, clearing the prison will take ages |
