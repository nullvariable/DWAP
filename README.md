...
## About Loot
* Low (default, recommended), which is vanilla loot for a container plus around 5 more items based on internal loot tables (more prepper like)
* Medium - fills containers to about 50% of capacity
* High - clears all vanilla and maxes container capacity
...
### Gun's Elevator mod
* [Gun's Elevator mod](https://steamcommunity.com/sharedfiles/filedetails/?id=3411580812)
...
| 5. Muldraugh Safehouse | 10710, 9549 |
| ------------- | ---------- |
| ![Muldraugh Safehouse](readme/05_ext.jpg) | ![Muldraugh Safehouse](readme/05_map.png) |
| Centered in a small gated community, this home features an large fallout shelter in the basement. Generator and water tank are found in the basement, but supply utilities for the whole home. Features plenty of storage and a nice area for gardening or raising animals. | ![Muldraugh Safehouse](readme/05_basement.png) |
| Optional mods supported | * n/a |
| ***Pros***: fully custom basement, solid location | ***Cons***: Small, lots of zombies |

| 6. Riverside Farmhouse | 6965, 5584 |
| ------------- | ---------- |
| ![Riverside Farmhouse](readme/06_ext.jpg) | ![Riverside Farmhouse](readme/06_map.png) |
...
| 7. Rosewood Zippee Apts | 8097, 11561 |
| ------------- | ---------- |
| ![Rosewood Gas Station](readme/07_ext.jpg) | ![Rosewood Gas Station](readme/07_map.png) |
| This large multistory building with businesses on the ground floor has a full generator in the basement supplying power for the full building. Water tanks in the basement supply the 3rd floor apartments directly but are easily modified to support other plumbing within the building. With many options for entrances and exits this building is a great fit for knocking out some walls to give your self some space. | ![Rosewood Gas Station](readme/07_basement.png) |
| Optional mods supported | * n/a |
| ***Pros***: Massive inside spaces and many apartments with supplies | ***Cons***: Smack in the center of town |

| 8. Rural West Point Mansion | 10162, 6622 |
| ------------- | ---------- |
| ![Rural West Point Mansion](readme/08_ext.jpg) | ![Rural West Point Mansion](readme/08_map.png) |
| Located off the beaten path, this small homestead is perfect for those seeking to get away from it all. A decent drive from West Point, this home has a large stable and shed. The basement includes generator, water tank, and fallout shelter. The whole home features plenty of storage and supplies. | ![Rural West Point Mansion](readme/08_basement.png) |
| Optional mods supported | * n/a |
| ***Pros***: super isolated, large basement | ***Cons***: super isolated, quite a trek to town |

| 9. Lowry Court Apartments | 12993, 1914 |
| ------------- | ---------- |
| ![Lowry Court Apartments](readme/09_LCA.jpg) | ![Lowry Court Apartments](readme/09_map.png) |
| These average apartments in the center of Louisville feature massive enclosed garage areas, a private courtyard (perhaps you can organize a community garden), a fallout shelter, generator, and water storage. While the entire building is not serviced, backup power and water can be found in 3rd floor apartments on the south west side. | ![Lowry Court Apartments](readme/09_basement.jpg) |
| Optional mods supported | * n/a |
...
| _This is a copy of the March Ridge cold war bunker, but with the entrance just behind the mall security office_ | ![Grand Ohio](readme/10_map_2.png) |
...
| Grittier than most places, this former factory bunkhouse may look rundown on the outside, but inside there are three floors of space. A small bomb shelter hides many essentials while the upper floors offer ample room to spread out. | ![Ekron Factory](readme/21_basement.png) |
| Optional mods supported | * n/a |
...
| 25. Riverside Mansion | 6880, 5509 |
| ------------- | ---------- |
| ![Riverside Mansion](readme/25_ext.jpg) | ![Riverside Mansion](readme/25_map.png) |
...
| 26. West Point Home | 11766, 6667 |
| ------------- | ---------- |
| ![West Point Home](readme/26_ext.jpg) | ![West Point Home](readme/26_map.png) |
...
| If feeling secure and away from it all is important to you, you'll be in hog heaven with this estate north west of Ekron. Surrounded by strong fences, featuring a pig barn, chicken coop, shed, detached garage and sun room, the only thing missing is a nice herb garden. Duck global disaster in your own private fallout shelter with large attached, fully outfitted workroom | ![Ekron Pig Farm](readme/28_basement.png) |
| Optional mods supported | * n/a |
...
| 31. Fallas Lake Hotel | 7244, 8258 |
| ------------- | ---------- |
| ![Fallas Lake Hotel](readme/31_ext.jpg) | ![Fallas Lake Hotel](readme/31_map.jpg) |
| Both in the middle of nowhere and in the middle of everywhere, Fallas Lake is the often overlooked home of thriving farming and hunting industry with plenty of facilities for all your various needs. This casual Hotel offers a solid revenue source. If you're looking for safety at the end of the world, checkout the 4 individual fallout shelters the previous owner had built, one for each of his children if anything ever happened each one would have a chance at surviving. | ![Fallas Lake Hotel](readme/31_basement.jpg) |
| Optional mods supported | * n/a |
...
| Once the home of an ultra-rich historical figure, this absolutely massive mansion caters to tourists, but if you want the full experience, slip past the guards and take the elevator down 10 floors underground to check out how the rich would live in the apocalypse. | ![Quill Manor](readme/32_basement.png) |
| Optional mods supported | * [Gun's Elevator mod](https://steamcommunity.com/sharedfiles/filedetails/?id=3411580812) *(Highly recommended) (42.20 compat unknown)* |
...
| Nothing beats a lake front getaway. This three floor, medium sized home on the south side of Dark Wallow lake has great fishing access. As long as flooding isn't a concern for you, the basement fallout shelter can easily support your long term survival needs. | ![Dark Wallow Cabin](readme/33_basement.png) |
...
| ------------- | ---------- |
| ![Far East Muldraugh Hunting Cabin](readme/34_main.jpg) | ![Far East Muldraugh Hunting Cabin](readme/34_map.png) |
| Get away from it all with this nicely isolated hunting cabin. The ultimate hunter's dream, this comfortable cabin features full power and water, and a large private lake with great fishing in case you need something when deer aren't in season. | ![Far East Muldraugh Hunting Cabin](readme/34_basement.png) |
| Optional mods supported | * n/a |
| ***Pros***: More fishing than you can shake a stick at | ***Cons***: Pretty far away from everything |

| 35. Muldraugh Drug Shack | 7674, 12268 |
| ------------- | ---------- |
| ![Muldraugh Drug Shack](readme/35_main.jpg) | ![Muldraugh Drug Shack](readme/35_map.png) |
| The drug trade is a rough life and it shows. This run down property features the leftovers of the drug trade, but shows great potential for the dedicated survivor looking to really put some ownership into how things look. Featuring a solid workroom and many leftovers, this fixer upper isn't far from Muldraugh proper, but far enough to feel like you're away from it all. | ![Muldraugh Drug Shack](readme/35_basement.jpg) |
| Optional mods supported | * n/a |
...
| Optional mods supported | * n/a |
| ***Pros***: Compact base with many supplies and easy access to fuel. | ***Cons***: Lots of stairs, not far from the big Brandenburg zombie populations, but far from other cities. |
...
| Start your dream business in this prime retail space. Just outside Louisville proper, this blank canvas is ready for your vision. Don't mind the old dusty shelter in the back room, the access to the highway entering Louisville is 2nd to none. | ![Kinsella Rd Shop For Lease](readme/38_basement.png) |
| Optional mods supported | * n/a |
...
| ------------- | ---------- |
| ![Leaf Hill Home](readme/39_main.jpg) | ![Leaf Hill Home](readme/39_map.png) |
...
| ------------- | ---------- |
| ![Secret Mausoleum](readme/41_main.jpg) | ![Secret Mausoleum](readme/41_map.jpg) |
...
| ------------- | ---------- |
| ![Louisville Townhouse](readme/42_main.png) | ![Louisville Townhouse](readme/42_map.png) |
